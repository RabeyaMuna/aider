...
class TestModels(unittest.TestCase):
    ...
    def test_max_context_tokens(self):
        ...
        self.assertEqual(model.info.get("max_input_tokens", 16385), 16385)
        ...
        model = Model("gpt-4")
        self.assertEqual(model.info.get("max_input_tokens", 8 * 1024), 8 * 1024)

        model = Model("gpt-4-32k")
        self.assertEqual(model.info.get("max_input_tokens", 32 * 1024), 32 * 1024)
